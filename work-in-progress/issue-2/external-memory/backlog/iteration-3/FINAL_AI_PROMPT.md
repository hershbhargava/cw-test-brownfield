...
|----------|-------|
| Repository | hershbhargava/cw-test-brownfield |
| Workspace | /persistent/git-workspaces/hershbhargava/cw-test-brownfield/issue-2/repos/hershbhargava/cw-test-brownfield/work-in-progress/issue-2/external-memory/backlog/iteration-3 |
...
**Iteration**: 3 for "Bug1 live-test: numeric issueNumber"
...
```
/persistent/git-workspaces/hershbhargava/cw-test-brownfield/issue-2/repos/hershbhargava/cw-test-brownfield/work-in-progress/issue-2/external-memory/backlog/iteration-3/
...
1. Write PRD_DELTA to: `/persistent/git-workspaces/hershbhargava/cw-test-brownfield/issue-2/repos/hershbhargava/cw-test-brownfield/docs/requirements`
   **Filename is required to be `PRD_DELTA_issue-2.md`** — do NOT shorten to `PRD_DELTA.md` or any other name. The `_issue-2` suffix is part of the project file-naming convention; downstream workflows look for that exact name.
2. Write metadata.json to: `/persistent/git-workspaces/hershbhargava/cw-test-brownfield/issue-2/repos/hershbhargava/cw-test-brownfield/work-in-progress/issue-2/external-memory/backlog/iteration-3/metadata.json`
...
1. Verify artifacts directory exists: `/persistent/git-workspaces/hershbhargava/cw-test-brownfield/issue-2/repos/hershbhargava/cw-test-brownfield/work-in-progress/issue-2/external-memory/backlog/iteration-3`
...
3. Use `git add /persistent/git-workspaces/hershbhargava/cw-test-brownfield/issue-2/repos/hershbhargava/cw-test-brownfield/work-in-progress/issue-2/external-memory/backlog/iteration-3`
4. Use `git commit -m "PRD iteration 3 for Bug1 live-test: numeric issueNumber - detailed mode"`
...
- `external-memory/prd/iteration-3/metadata.json` — machine-readable metrics
- `external-memory/prd/iteration-3/GITHUB_COMMENT.md` — this comment
