...
- **Node/TypeScript**: ensure FROM matches package.json's `engines.node` field if set; otherwise pin to latest LTS slim (`node:22-slim`).
...
- **Node/TypeScript**: ensure FROM matches package.json's `engines.node` field if set; otherwise pin to latest LTS slim (`node:22-slim`). `ENV NODE_ENV=test` if any package.json script reads it.
...
- `/persistent/git-workspaces/hershbhargava/cw-test-brownfield/issue-1/repos/hershbhargava/cw-test-brownfield/.coweave/manifest.yml`
- `/persistent/git-workspaces/hershbhargava/cw-test-brownfield/issue-1/repos/hershbhargava/cw-test-brownfield/.coweave/docker-compose.yml`
- `/persistent/git-workspaces/hershbhargava/cw-test-brownfield/issue-1/repos/hershbhargava/cw-test-brownfield/.coweave/Dockerfile.test-runner`
...
- `/persistent/git-workspaces/hershbhargava/cw-test-brownfield/issue-1/repos/hershbhargava/cw-test-brownfield/.coweave/docker-compose.yml`
- `/persistent/git-workspaces/hershbhargava/cw-test-brownfield/issue-1/repos/hershbhargava/cw-test-brownfield/.coweave/Dockerfile.test-runner`
Iteration artifacts:  `/persistent/git-workspaces/hershbhargava/cw-test-brownfield/issue-1/repos/hershbhargava/cw-test-brownfield/work-in-progress/issue-1/external-memory/prd/iteration-3/`
